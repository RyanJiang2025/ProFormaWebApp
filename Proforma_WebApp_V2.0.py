...
if st.session_state.toggle:
    button_label = "Amenities off"
    state_text = "🟢 ON"
else:
    button_label = "Amenities on"
    state_text = "🔴 OFF"
...
st.write("Current state:", state_text)
...
if st.session_state.toggle:
    ...
    ranking_Housing_Micro = 0
    ranking_InBuilding_Grocery = 0
    ranking_InBuilding_CommunityCenter = 0
    ranking_OffSite_ParkPlaza = 0
